...
Or download
  http://cloud.github.com/downloads/shaliko/shoulda-tmbundle/Shoulda.zip[http://cloud.github.com/downloads/shaliko/shoulda-tmbundle/Shoulda.zip]
...
* Shoulda::ActiveRecord::Macros
  * should_allow_mass_assignment_of (same)
  * should_allow_values_for (savf)
  * should_belong_to (sbt)
